...
Sáng thứ 2, 02:14. Pager kêu. Bạn mở laptop, login vào dashboard, và thấy: 47 alert đỏ trong vòng 90 giây. Payment latency cao. Checkout 5xx tăng. Edge load balancer p99 vượt 3 giây. Notification queue lag. Database CPU 95%. Cart-redis evict. Recommender OOM.

7 service báo lỗi cùng lúc. Hỏi đầu tiên trong đầu bạn: “Cái nào đang gây ra cái còn lại?”
...
- MTTR trung bình tăng 2.4x khi alert flood (> 5 alert / phút) so với baseline
...
### 1.2 4 nguyên nhân chính của alert flood
...
### 1.3 Mục tiêu cụ thể của bạn cuối ngày
